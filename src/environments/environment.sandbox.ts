export const environment = {
    ...
    auth: {
      ...
      redirectUri: 'https://mediaplayer.dev.auckland.ac.nz',
      logout_uri: 'https://mediaplayer.dev.auckland.ac.nz',
    ...
    signedCookieApiEndpoint: 'https://apigw.sandbox.amazon.auckland.ac.nz/media-cookies'
  };